...
namespace TransmitTiledImages
{
    ...
    public partial class SetupForm : Form
    {
        ...
        private PvDeviceInfoType mSetupType;

#region Constructors
        /// <summary>
        /// Constructors
        /// </summary>
        public SetupForm(PvDeviceInfoType aType)
        {
            InitializeComponent();
            mSetupType = aType;
        }
        ...
        public SetupForm(ref Setup aSetup, PvDeviceInfoType aType)
        {
            InitializeComponent();
            mSetup = aSetup;
            mSetupType = aType;
            ...
            // Destination
            if (mSetupType == PvDeviceInfoType.GEV)
            {
            ...
            {
                streamDestinationGroupBox.Enabled = false;
            }
