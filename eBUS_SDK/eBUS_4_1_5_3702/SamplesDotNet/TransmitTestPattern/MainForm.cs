        ...
        private void InitializeParameters()
        {
            ...
            foreach (PvInterface lInterface in lSystem)
            {
                ...
                if (lNetworkAdapter.IPAddress.CompareTo( "0.0.0.0" ) != 0)
                {
                    ...
                    sourceAddressComboBox.Items.Add(lNetworkAdapter.IPAddress);
                }
            }
        ...
        private bool TransmittData()
        {
            ...
            try
            {
                ...
                if (lFPS > 0)
                {
                    ...
                    mTransmitter.MaxPayloadThroughput = lPayLoadSize;
                }
                ...
                for ( Int32 i = 0; i < lPoolSize; i++ )
                {
                    ...
                    lBufferList[i].Image.Alloc(lWidth, lHeight, lPvPixelType);
                }
                ...
                mTransmitter.Open( destinationAddressTextBox.Text, Convert.ToUInt16( destinationPortTextBox.Text ), sourceAddressComboBox.Text, Convert.ToUInt16( sourcePortTextBox.Text ) );
