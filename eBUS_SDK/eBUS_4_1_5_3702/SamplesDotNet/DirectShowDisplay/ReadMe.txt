...
This sample could have used the DirectShow.NET wrappers but we chose instead to
simply focus on using native COM directly from the application code. Making the 
transition to DirectShow.NET could easily be performed from this sample.
