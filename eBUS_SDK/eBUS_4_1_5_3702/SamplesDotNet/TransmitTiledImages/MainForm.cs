    ...
    public partial class MainForm : Form
    {
        ...
        private bool PopulateNICAddress()
        {
            ...
            foreach (PvInterface lInterface in lSystem)
            {
                ...
                if (lNetworkAdapter.IPAddress.CompareTo("0.0.0.0") != 0)
                {
                    // Add found IP address of the NIC to interfaceAddressComboBox.
                    interfaceAddressComboBox.Items.Add(lNetworkAdapter.IPAddress);
                    // Found NIC.
                    lFoundNic = true;
                }
            }
        ...
        private void ConnectDevice(UInt16 aRow, UInt16 aColumn)
        {
            ...
            try
            {
                ...
                PvDeviceInfoGEV lDeviceInfoGEV = lPvDevInfo as PvDeviceInfoGEV;
