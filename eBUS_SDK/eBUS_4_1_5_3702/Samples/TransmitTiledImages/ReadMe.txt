...
Each of the GigE Vision transmitter source are managed by independent threads ( StreamThread ). The latest image acquire by the thread is stored in the SmartBuffer who is stored in the CurrentBuffersTable. 
