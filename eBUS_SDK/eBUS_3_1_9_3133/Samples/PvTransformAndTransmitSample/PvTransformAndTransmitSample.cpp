...
// * Resample it and print text on it
...
// The text is printed onto the resampled video using GDI+.
//
...
// receiving from that device, resamples the video to RGB24 640X480, renders
