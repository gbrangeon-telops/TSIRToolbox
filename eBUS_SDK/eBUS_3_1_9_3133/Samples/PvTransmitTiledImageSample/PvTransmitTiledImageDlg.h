...
///
/// \class CPvTransmitTiledImageDlg
///
/// \brief Main dialog of the sample.
///
class CPvTransmitTiledImageDlg : public CDialog
{
// Construction
public:
	CPvTransmitTiledImageDlg(CWnd* pParent = NULL);	// standard constructor
    virtual ~CPvTransmitTiledImageDlg();
...
private:
    ...
    PvVirtualDevice mVirtualDevice;
...
public:
    afx_msg void OnStnClickedStaticMac22();
};
