...
// example such as PvTransmitTestPatternSample before attempting to dissect 
// the source code of PvTransmitTiledImageSample.
// 
...
// 	  8. Start your receiver (such as a vDisplay or GEVPlayer) and listen for 
...
BEGIN_MESSAGE_MAP(CPvTransmitTiledImageApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CPvTransmitTiledImageApp construction

CPvTransmitTiledImageApp::CPvTransmitTiledImageApp()
{
...
// The one and only CPvTransmitTiledImageApp object

CPvTransmitTiledImageApp theApp;


// CPvTransmitTiledImageApp initialization

BOOL CPvTransmitTiledImageApp::InitInstance()
{
