            ...
            while (!mStopTransmit)
            {
                ...
                for (;;)
                {
                    ...
                    if (lResult.IsOK && (lBuffer != null))
                    {
                        ...
                        {
                            mDisplay.Display(lBuffer, false);
                        }
        ...
        public bool Configure(TransmitterConfig aTransmitterConfig, Int32 aMaxWidth, Int32 aMaxHeight)
        {
            ...
            try
            {
                    ...
                    (mTransmitterRaw.DestinationPort != mTransmitterRawConfig.DestinationPort))
                {
                    ...
                    mTransmitterRaw.Open(mTransmitterRawConfig.DestinationIPAddress, mTransmitterRawConfig.DestinationPort, mTransmitterRawConfig.SourceIPAddress);
                }
                // Reset the statistic
