...
#region Data members
        ...
        private PvVirtualDevice mVirtualDevice = new PvVirtualDevice();
...
#region Utilities methods
        ...
        private void InitializesOptionsAndDataMembers()
        {
            ...
            mConnectionLabels[0, 0] = new ConnectionLabels(ipLabel1, macLabel1, modelLabel1);
            mConnectionLabels[0, 1] = new ConnectionLabels(ipLabel2, macLabel2, modelLabel2);
            mConnectionLabels[1, 0] = new ConnectionLabels(ipLabel3, macLabel3, modelLabel3);
            mConnectionLabels[1, 1] = new ConnectionLabels(ipLabel4, macLabel4, modelLabel4);
        ...
        private bool PopulateNICAddress()
        {
            ...
            PvInterface lPvInterface;
            lPvSystem.Find();
            for (UInt16 i = 0; i < lPvSystem.InterfaceCount; i++)
            {
                lPvInterface = lPvSystem.GetInterface(i);
                if (lPvInterface.IPAddress.CompareTo("0.0.0.0") != 0)
                {
                    // Add found IP address of the NIC to interfaceAddressComboBox
                    interfaceAddressComboBox.Items.Add(lPvInterface.IPAddress);
                    // Found NIC
                    lFoundNic = true;
                }
            }
        ...
        private void Start()
        {
            ...
            {
                MessageBox.Show("Invalid destination IP address!", "PvTransmitTiledImageSample");
                return;
            }
        ...
        private void Open()
        {
            ...
            try
            {
                ...
                Text = "PvTransmitTiledImageSample - " + lFileName;
        ...
        private void SaveAs( string aFileName )
        {
            ...
            try
            {
                ...
                Text = "PvTransmitTiledImageSample - " + aFileName;
                saveToolStripMenuItem.Enabled = true;
            }
            catch (PvException lPvExc)
            {
        ...
        void OpenBrowser(StreamThread aST, int aParameters)
        {
            ...
            switch (aParameters)
            {
                case 0:
                    ...
                    lParams = aST.Device.GenLink;
                    break;

                case 1:
                    lTitle = aIndex.ToString() + ": Device parameters";
                    lParams = aST.Device.GenParameters;
                    break;
...
#region Public methods
        ...
        public void OnDisconnectHandler(int aRow, int aColumn)
        {
            ...
            string lTitle = string.Format("Lost connection at: ( {0}, {1} ) {2}, {3} [ {4} ]", aRow + 1, aColumn + 1, mStreamThreads[aRow, aColumn].Model, mStreamThreads[aRow, aColumn].MACAddress, mStreamThreads[aRow, aColumn].IPAddress);
...
#region Windows events
        ...
        private void browserButton_Click(object sender, EventArgs e)
        {
            ...
            streamMenuItem.Enabled = (lST.Device != null) && lST.Stream.IsOpened;
