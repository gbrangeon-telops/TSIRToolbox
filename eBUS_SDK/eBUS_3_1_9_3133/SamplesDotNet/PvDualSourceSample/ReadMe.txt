...
This sample works just like PvSimpleUISample except that it allows receiving data
from two sources.
...
If your only has a single source, the left display is used and the acqusition controls
